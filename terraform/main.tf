...
module "static_website" {
  source = "git::git@github.com:tnn-tnn-gruntwork-io/package-static-assets.git//modules/s3-static-website?ref=v0.1.0"
...
module "cloudfront" {
  source = "git::git@github.com:tnn-tnn-gruntwork-io/package-static-assets.git//modules/s3-cloudfront?ref=v0.1.0"
